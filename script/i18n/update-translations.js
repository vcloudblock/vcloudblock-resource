 ...
 * Use --thirdParty=true to generate translation files for unofficial resources.
 */
...
const {dir, thirdParty} = parseArgs();
    ...
    try {
        ...
        return splitLocales(localeData).then(data => {
            Object.keys(data).forEach(filePath => {
                ...
                const interfaceFile = path.join(filePath, INTERFACE_FILE);
                const official = isOfficial(interfaceFile);
