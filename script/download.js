 ...
 *
 * use --repo to specify the download address, e.g: --repo=vcloudblock/external-resources
 * use --plat to Specify the download platform, gitee or github
 * use --cdn to specify the use of the cdn proxy server address, e.g: --cdn=https://cdn.vcloudblock.cn/
 */
