 ...
 * @readonly
 */
const DEFAULT_CACHE_RESOURCES_PATH = path.join(__dirname, '../../.vcloudblockData/external-resources');
 ...
 * @readonly
 */
const SERVER_NAME = 'vcloudblock-resource-server';

/**
 * The time interval for retrying to open the port after the port is occupied by another vcloudblock-resource server.
 * @readonly
 */
